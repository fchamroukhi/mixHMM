...
RcppExport SEXP _mixHMM_forwards_backwards(SEXP priorSEXP, SEXP transmatSEXP, SEXP f_tkSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_mixHMM_forwards_backwards", (DL_FUNC) &_mixHMM_forwards_backwards, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_mixHMM(DllInfo *dll) {
